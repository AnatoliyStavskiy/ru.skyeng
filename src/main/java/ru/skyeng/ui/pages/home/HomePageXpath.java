...
public class HomePageXpath {
    ...
    public static final String HEADER_MENU_NEW_PROFESSION = "/html[1]/body[1]/skyeng-ff[1]/div[1]/marketing-core-cms-main-page[1]/marketing-core-cms-index[1]/div[1]/cms-blocks-layout-header[1]/div[1]/header[1]/div[1]/div[1]/cms-blocks-layout-header-navigation[1]/nav[1]/cms-blocks-layout-header-item[4]/div[1]/a[1]";
    ...
    public static final String HEADER_MENU_TEACHERS = "/html/body/skyeng-ff/div/marketing-core-cms-main-page/marketing-core-cms-index/div/cms-blocks-layout-header/div/header/div/div[1]/cms-blocks-layout-header-navigation/nav/cms-blocks-layout-header-item[6]/div";
