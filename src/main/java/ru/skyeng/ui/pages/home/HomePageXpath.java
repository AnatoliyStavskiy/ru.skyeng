...
public class HomePageXpath {
    ...
    public static final String HEADER_MENU_MORE_XPATH = "/html/body/skyeng-ff/div/marketing-core-cms-main-page/marketing-core-cms-index/div/cms-blocks-layout-header/div/header/div/div[1]/cms-blocks-layout-header-navigation/nav/div/cms-blocks-layout-header-menu/div[1]/div[2]/span";
    public static final String HEADER_MENU_MORE_2 = "//span[text()='Ещё']";
    ...
    public static final String HEADER_MENU_TEACHERS_OLD = "//a[@href='https://job.skyeng.ru/english-teachers?utm_source=skyeng&amp;utm_medium=newbutton&amp;utm_campaign=headerprepfromskyeng']";
